...
export const ARRIVAL_TOTAL = 3; // 2 chamados de fundo (8161, 8162) + protagonista (8182)
...
/** Código do chamado no formato "#CH-0008182" (7 dígitos, zeros à esquerda). */
 ...
 * para o mais antigo). O topo replica a fila do Supervisor (cena "demanda
 * crítica sobe"): #CH-0008182 (crítica, usuário preso no elevador) e
 * #CH-0008181 (alta, Smart Fit) à frente dos normais 8170/8168/8166/8159.
 * ------------------------------------------------------------------------- */
...
export const INITIAL_QUEUE = comTimeline([
  chamado({
    id: 8182, local: 'Hospital Central Paulista', equipamento: 'Elevador de Leitos - E02',
    ocorrencia: 'Usuário preso no elevador', prioridade: 'critica', regiao: 'Centro',
    status: 'atendimento', slaPct: 100, slaRestante: 'estourado', responsavel: 'Téc. João da Silva',
    chegada: '13:58', contrato: 'CT-2025-00141',
  }),
  chamado({
    id: 8181, local: 'Academia Smart Fit Vila Olímpia', equipamento: 'Elevador Social - E03',
    ocorrencia: 'Botão de emergência com desgaste', prioridade: 'alta', regiao: 'Zona Sul',
    status: 'atendimento', slaPct: 88, slaRestante: '50 min', responsavel: 'Téc. Paulo Menezes',
    chegada: '13:56', contrato: 'CT-2025-00142',
  }),
  chamado({
    id: 8170, local: 'Residencial Jardim das Acácias', equipamento: 'Elevador Social - E01',
    ocorrencia: 'Display do indicador de piso apagado', prioridade: 'normal', regiao: 'Zona Sul',
    status: 'encaminhado', slaPct: 10, slaRestante: '6h 20min', responsavel: 'Superv. Renata Alves',
    chegada: '13:54', contrato: 'CT-2025-00143',
  }),
  chamado({
    id: 8168, local: 'Galeria Paulista Offices', equipamento: 'Elevador de Carga - E02',
    ocorrencia: 'Freio com ruído intermitente', prioridade: 'normal', regiao: 'Centro',
    status: 'encaminhado', slaPct: 15, slaRestante: '5h 55min', responsavel: 'Superv. Marina Duarte',
    chegada: '13:52', contrato: 'CT-2025-00144',
  }),
  chamado({
    id: 8166, local: 'Hotel Bourbon Convention Ibirapuera', equipamento: 'Elevador Social - E05',
    ocorrencia: 'Alarme de cabine acionando sem parar', prioridade: 'normal', regiao: 'Zona Sul',
    status: 'encaminhado', slaPct: 21, slaRestante: '5h 30min', responsavel: 'Superv. Renata Alves',
    chegada: '13:50', contrato: 'CT-2025-00145',
  }),
  chamado({
    id: 8159, local: 'Centro de Convenções Rebouças', equipamento: 'Elevador Panorâmico - E01',
    ocorrencia: 'Iluminação da cabine oscilando', prioridade: 'normal', regiao: 'Zona Oeste',
    status: 'encaminhado', slaPct: 27, slaRestante: '5h 05min', responsavel: 'Superv. Fábio Neves',
    chegada: '13:48', contrato: 'CT-2025-00146',
  }),
  chamado({
 ...
 * #CH-0008168..#CH-0008151 e os 3 mais recentes chegam um a um pelo topo.
 * ------------------------------------------------------------------------- */

/* Chegadas da abertura, em ordem: 8170, 8181, 8182 (a crítica chega por último e assume o topo). */
export const PAGE_ARRIVALS = INITIAL_QUEUE.slice(0, 3).reverse();

/* Fila visível no instante em que a página é aberta: 8168 .. 8151. */
...
/* ---------------------------------------------------------------------------
 * PROTAGONISTA — #CH-0008182 (Hospital Central Paulista · Elevador de
 * Leitos - E02). É a demanda CRÍTICA "Usuário preso no elevador" da cena do
 * Supervisor: chega à fila já classificada como prioritária pelo BackOffice.
 * ------------------------------------------------------------------------- */
export const PROTAGONISTA = {
  ...
  localEquipamento: fmtLocal('Hospital Central Paulista', 'Elevador de Leitos - E02'),
  ocorrencia: 'Usuário preso no elevador',
  contrato: 'CT-2025-00141',
  regiaoFinal: 'Centro',
  protagonista: true,
  chegada: '14:02',
};
...
export const TIMELINE_PROTAGONISTA = [
  ...
  {
    hora: '14:03',
    desc: 'Contexto consolidado: hospital, elevador de leitos com usuário preso, contrato CT-2025-00141 e SLA de chegada de 30 min',
    origem: 'backoffice',
  },
  { hora: '14:04', desc: 'Prioridade Crítica definida — demanda prioritária, região Centro', origem: 'backoffice' },
  { hora: '14:05', desc: 'Encaminhado ao supervisor da região Centro', origem: 'backoffice' },
  ...
  {
    hora: '15:12',
    desc: 'Chamado concluído, TB 1h10 — fechamento: Substituição do sensor de nível e da placa de comando',
    origem: 'otis',
  },
];
...
export const PROTAGONISTA_ESTAGIOS = {
  ...
  priorizado: {
    status: 'aberto', prioridade: 'critica', regiao: 'Centro',
    slaPct: 7, slaRestante: '28 min', responsavel: null,
  },
  encaminhado: {
    status: 'encaminhado', prioridade: 'critica', regiao: 'Centro',
  ...
  'em-atendimento': {
    status: 'atendimento', prioridade: 'critica', regiao: 'Centro',
    slaPct: 80, slaRestante: '6 min', responsavel: 'Téc. João da Silva · ETA 4 min',
  },
  concluido: {
    status: 'concluido', prioridade: 'critica', regiao: 'Centro',
    slaPct: 93, slaRestante: 'TA 28 min', responsavel: 'Téc. João da Silva',
  },
};
 ...
 * ------------------------------------------------------------------------- */
/* Sem itens dos chamados que chegam na abertura (8170, 8181, 8182): o feed ganha
...
export const FEED_CHEGADAS = [
  ...
  {
    hora: '14:02',
    texto: 'Chamado #CH-0008182 recebido do Sistema OTIS — consolidação de contexto iniciada',
    origem: 'otis',
  },
];
...
export const FEED_ESTAGIO = {
  priorizado: {
    hora: '14:04', texto: 'Chamado #CH-0008182 priorizado como Crítica — demanda prioritária, região Centro', origem: 'backoffice',
  },
  encaminhado: {
    hora: '14:05', texto: 'Chamado #CH-0008182 encaminhado ao supervisor da região Centro', origem: 'backoffice',
  },
  alerta: {
    hora: '14:24', texto: 'Alerta de SLA: #CH-0008182 com 73% do prazo consumido', origem: 'backoffice',
  },
  'em-atendimento': {
    hora: '14:26', texto: 'Chamado #CH-0008182 em atendimento — técnico designado, ETA 4 min', origem: 'supervisor',
  },
  concluido: {
    hora: '15:12', texto: 'Chamado #CH-0008182 concluído — TA 28 min, TB 1h10', origem: 'otis',
  },
};
